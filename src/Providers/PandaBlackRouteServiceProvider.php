...
class PandaBlackRouteServiceProvider extends RouteServiceProvider
{
    ...
    public function map(Router $router, ApiRouter $api)
    {
        ...
        $api->version(['v1'], ['middleware' => ['oauth']], function ($router) {
            ...
            $router->get('markets/panda-black/products-status', 'PandaBlack\Controllers\OrderController@createOrder');
            ...
            $router->get('markets/panda-black/notifications', 'PandaBlack\Controllers\AttributeController@updatePBAttributeInPM');
