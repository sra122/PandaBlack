...
class PandaBlackRouteServiceProvider extends RouteServiceProvider
{
    ...
    public function map(Router $router, ApiRouter $api)
    {
        ...
        $router->get('orders', 'PandaBlack\Controllers\OrderController@createOrder');
        ...
        $api->version(['v1'], ['middleware' => ['oauth']], function ($router) {
            ...
            //Delete Properties
            $router->post('markets/panda-black/delete-properties', 'PandaBlack\Controllers\AttributeController@deletePBProperties');
        });
    }
}