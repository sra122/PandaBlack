...
class PandaBlackRouteServiceProvider extends RouteServiceProvider
{
    ...
    public function map(Router $router, ApiRouter $api)
    {
        ...
        $api->version(['v1'], ['middleware' => ['oauth']], function ($router) {
            ...
            $router->post('markets/panda-black/products-data', 'PandaBlack\Controllers\ContentController@getReferrerId');
            $router->get('markets/panda-black/products-status', 'PandaBlack\Controllers\ContentController@getReferrerId');
